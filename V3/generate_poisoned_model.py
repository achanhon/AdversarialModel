...
trainset = torchvision.datasets.ImageFolder(root='build/poisonned/train', train=True, download=True, transform=transform_train)
...
def train(epoch):
    ...
    if epoch%50==49:
        torch.save("poisonnedmodel.pth",net.state_dict())
